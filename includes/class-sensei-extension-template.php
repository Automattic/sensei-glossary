...
class Sensei_Extension_Template {
	...
	public function __construct ( $file, $version = '1.0.0' ) {
		...
		$this->_token = 'sensei_extension_template';
	...
	/**
	 * Main Sensei_Extension_Template Instance
	 *
	 * Ensures only one instance of Sensei_Extension_Template is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Sensei_Extension_Template()
	 * @return Main Sensei_Extension_Template instance
	 */
